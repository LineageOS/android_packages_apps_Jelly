...
class WebViewExt @JvmOverloads constructor(
    ...
    private fun setup() {
        ...
        if (settings.userAgentString.contains("Version")) {
            settings.userAgentString = settings.userAgentString.replace(Regex("\\s*Version/\\S+\\s*"), " ")
        }
    ...
    companion object {
        ...
        private const val DESKTOP_USER_AGENT_FALLBACK =
            "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/131.0.6778.136 Safari/537.36"
