...
internal class ChromeClient(private val mActivity: WebViewExtActivity, private val mIncognito: Boolean,
                            private val mUrlBarController: UrlBarController, private val mProgressBar: ProgressBar) : WebChromeClient() {
    ...
    override fun onCreateWindow(view: WebView, isDialog: Boolean,
        ...
        mActivity.openInNewTab(url, mIncognito)
        return true
    }
}