...
public final class PrefsUtils {
    ...
    private static final String KEY_INCOGNITO_DEFAULTS = "key_incognito_defaults";
    ...
    public static int getIncognitoDefaults(Context context)  {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return Integer.parseInt(prefs.getString(KEY_INCOGNITO_DEFAULTS, "0"));
    }
