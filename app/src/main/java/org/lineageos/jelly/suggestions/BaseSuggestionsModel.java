...
public abstract class BaseSuggestionsModel {
     ...
     */
    protected abstract void parseResults(@NonNull InputStream inputStream, @NonNull List<SuggestionItem> results) throws Exception;
    ...
    BaseSuggestionsModel(@NonNull Application application, @NonNull String encoding) {
        ...
        mHttpClient = new OkHttpClient.Builder()
                .cache(new Cache(suggestionsCache, 1024 * 1024))
