...
class UrlBarLayout @JvmOverloads constructor(
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        autoCompleteTextView.setOnFocusChangeListener { _, hasFocus -> this.hasFocus = hasFocus }
        ...
        searchEditText.setOnFocusChangeListener { _, hasFocus -> this.hasFocus = hasFocus }
