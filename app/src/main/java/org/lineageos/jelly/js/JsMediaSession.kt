        ...
        const val SCRIPT = """
            (() => {
                ...
                const onCreate = (media, event) => {
                    if ($MEDIA && $MEDIA.src === media.src) {
                        if (event === 'play') $INTERFACE.onPlay();
                        return;
                    }
                    const metadata = navigator.mediaSession.metadata;
                    if (!metadata || media.autoplay || media.muted || media.paused) return;
                    media.onwaiting = () => {
                    ...
                    media.onplaying = () => {
                        ...
                        $INTERFACE.onPlaying(media.currentTime, duration);
                    };
                    media.onratechange = () => {
                    ...
                    $MEDIA = media;
                    $INTERFACE.onCreate(...metadataArgs(metadata));
                };
