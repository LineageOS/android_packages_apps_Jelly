...
class HistoryActivity : AppCompatActivity() {
        ...
        val helper = ItemTouchHelper(HistoryCallBack(this, object : OnDeleteListener {
            override fun onItemDeleted(data: ContentValues?) {
                ...
                Snackbar.make(rootView, R.string.history_snackbar_item_deleted, Snackbar.LENGTH_LONG)
                        .setAction(R.string.history_snackbar_item_deleted_message) { contentResolver.insert(HistoryProvider.Columns.CONTENT_URI, data) }
                        .show()
            }
        }))
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        AlertDialog.Builder(this)
                ...
                ) { _: DialogInterface?, _: Int -> deleteAll() }
    ...
    private class DeleteAllHistoryTask internal constructor(private val contentResolver: ContentResolver, private val dialog: AlertDialog) : AsyncTask<Void?, Void?, Void?>() {
