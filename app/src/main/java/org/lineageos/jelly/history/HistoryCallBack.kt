...
internal class HistoryCallBack(context: Context) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
    ...
    override fun onChildDraw(c: Canvas, recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder,
        ...
        val iconTop = view.top + (view.bottom - view.top - mDelete.intrinsicHeight) / 2
