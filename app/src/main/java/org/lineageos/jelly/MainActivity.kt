...
class MainActivity : WebViewExtActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    override fun onWebShare(value: WebShare) {
        ...
        val shareIntent = if (value.files != null) {
            Intent(Intent.ACTION_SEND_MULTIPLE).apply {
                type = "*/*"
                putParcelableArrayListExtra(Intent.EXTRA_STREAM, value.files)
        ...
        startActivity(Intent.createChooser(shareIntent, value.title))
    }
