...
public class MainActivity extends WebViewExtActivity implements View.OnTouchListener,
    ...
    private void setupSearch() {
        ...
        UiUtils.showKeyboard(search_menu_edit);
        ...
        search_menu_edit.setOnEditorActionListener((v, actionId, event) -> {
            if (actionId == EditorInfo.IME_ACTION_SEARCH) {
                UiUtils.hideKeyboard(search_menu_edit);
                return true;
            }
            return false;
        });
        ...
        mWebView.setFindListener((activeMatchOrdinal, numberOfMatches, isDoneCounting) -> {
            ...
            if (numberOfMatches > 0) {
                search_status.setText(activeMatchOrdinal + 1 + "/" + numberOfMatches);
            } else {
                search_status.setText("");
                search_menu_edit.setTextColor(getColor(R.color.colorDelete));
            }
        });
