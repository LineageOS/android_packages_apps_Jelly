...
public class MainActivity extends WebViewExtActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            adblockEnabled = savedInstanceState.getBoolean(IntentUtils.EXTRA_ADBLOCK_ENABLED, false);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean(IntentUtils.EXTRA_DESKTOP_MODE, mWebView.isAdblockEnabled());
