...
public class MainActivity extends WebViewExtActivity implements View.OnTouchListener,
    ...
    private boolean mSearchSuccesfull;
    ...
    private void setupSearch() {
        ...
        mWebView.setFindListener((activeMatchOrdinal, numberOfMatches, isDoneCounting) -> {
            ...
            mSearchSuccesfull = numberOfMatches > 0;
            // Enable prev/next if matches are more than 0
            UiUtils.setImageButtonEnabled(this, mSearchSuccesfull, searchMenuPrev);
            UiUtils.setImageButtonEnabled(this, mSearchSuccesfull, searchMenuNext);
            // Update status text
        ...
        searchMenuPrev.setOnClickListener(v -> {
            if (mSearchSuccesfull && !lastSearch.isEmpty()) {
