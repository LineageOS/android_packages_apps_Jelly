...
public class MainActivity extends WebViewExtActivity implements
    ...
    private static class SetAsFavoriteTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public SetAsFavoriteTask(ContentResolver contentResolver, String title, String url,
        ...
        protected void onPostExecute(Boolean aBoolean) {
            ...
            if (view != null) {
                Snackbar.make(view, view.getContext().getString(R.string.favorite_added), Snackbar.LENGTH_LONG).show();
            }
        }
    }
}
