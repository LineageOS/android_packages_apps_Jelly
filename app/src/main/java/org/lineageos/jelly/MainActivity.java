...
public class MainActivity extends WebViewExtActivity implements View.OnTouchListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAutoCompleteTextViewExt.addTextChangedListener(this);
        mAutoCompleteTextViewExt.setThreshold(-1);
        mAutoCompleteTextViewExt.setDropDownWidth(-1);
        mAutoCompleteTextViewExt.setDropDownAnchor(R.id.toolbar);
        mAutoCompleteTextViewExt.setSelectAllOnFocus(true);

        mAutoCompleteTextViewExt.setOnItemClickListener((adapterView, view, pos, l) -> {
            String url = null;
        ...
        mAutoCompleteTextViewExt.setAdapter(mAdaper);
