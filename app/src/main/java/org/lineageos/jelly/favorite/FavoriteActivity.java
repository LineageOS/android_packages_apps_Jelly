...
public class FavoriteActivity extends AppCompatActivity {
    ...
    private static class UpdateFavoriteTask extends AsyncTask<Void, Void, Boolean> {
        private final ContentResolver contentResolver;
        private final long id;
        private final String title;
        private final String url;

        public UpdateFavoriteTask(ContentResolver contentResolver, long id, String title, String url) {
    ...
    private static class DeleteFavoriteTask extends AsyncTask<Long, Void, Boolean> {
        private final ContentResolver contentResolver;

        public DeleteFavoriteTask(ContentResolver contentResolver) {
            this.contentResolver = contentResolver;
        }
