...
class FavoriteProvider : ContentProvider() {
    ...
    private var mDbHelper: FavoriteDbHelper? = null
    ...
    override fun update(uri: Uri, values: ContentValues?,
        ...
        count = when (match) {
            ...
            MATCH_ID -> {
                ...
                db.update(FavoriteDbHelper.DB_TABLE_FAVORITES, values, BaseColumns._ID + " = ?", arrayOf(uri.lastPathSegment))
            }
    ...
    private class FavoriteDbHelper internal constructor(context: Context?) : SQLiteOpenHelper(context, DB_NAME, null, DB_VERSION) {
